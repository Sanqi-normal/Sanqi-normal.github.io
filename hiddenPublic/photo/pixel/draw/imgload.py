    ...
    with open(output_file, 'w', encoding='utf-8') as outfile:
        ...
        for filename in os.listdir(folder_path):
            ...
            if any(filename.lower().endswith(ext) for ext in image_extensions):
                # 写入Markdown格式的图片引用
                outfile.write(f"![](https://testingcf.jsdelivr.net/gh/Sanqi-normal/Sanqi-normal.github.io/photo/pixel/draw/{filename})\n")
...
# 使用示例
folder_path = 'c:\\Users\\28171\\hexo-blog\\source\\photo\\pixel\\draw'
output_file = 'c:\\Users\\28171\\hexo-blog\\source\\photo\\pixel\\img.md'
post_md_file = 'c:\\Users\\28171\\hexo-blog\\source\\photo\\pixel\\index.md'
