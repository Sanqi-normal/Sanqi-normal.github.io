    ...
    with open(output_file, 'w', encoding='utf-8') as outfile:
        ...
        for filename in os.listdir(folder_path):
            ...
            if any(filename.lower().endswith(ext) for ext in image_extensions):
                # 写入html格式的图片引用
                outfile.write(f'<img src="https://testingcf.jsdelivr.net/gh/sanqi-normal/sanqi-normal.github.io/photo/collection/img_left/{filename}">\n')
...
# 使用示例
folder_path = 'c:\\Users\\28171\\hexo-blog\\source\\photo\\collection\\img_left'
output_file = 'c:\\Users\\28171\\hexo-blog\\source\\photo\\collection\\imgleft.md'
...
# 定义起始和结束标记
start_marker = "<!-- 左半部分开始图片替换 -->"
end_marker = "<!-- 左半部分结束图片替换 -->"
